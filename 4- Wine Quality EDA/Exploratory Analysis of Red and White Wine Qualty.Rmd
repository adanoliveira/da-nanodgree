...
# set global chunk options: images will be 9.2x5 inches
knitr::opts_chunk$set(fig.width=9.2, 
                      fig.height=5, 
                      fig.path='Figs/', 
                      echo=FALSE, 
                      warning=FALSE, 
...
qplot(wine$quality, 
      fill = wine$type) +
  labs(list (title = "Histogram of Wine Quality Rating", 
...
p1 <- qplot(wine$alcohol, 
            fill = wine$type,
            binwidth =0.5) +
  geom_vline(aes(xintercept = mean(wine$alcohol)), 
             colour = "red", 
             size = 1,
             show.legend = T) +
  geom_vline(aes(xintercept = quantile(wine$alcohol, probs = c(.25, .50, .75))), 
             colour = "black", 
             linetype = "dashed",
             show.legend = T) +
  labs(list (title = "Histogram of Alcohol Concentration in Wines", 
             x = "Alcohol Concentration (% of Volume)", 
             y = "Ocurrences")) +
  scale_fill_discrete(name="Wine Type") +
  theme(legend.position="bottom")
...
p2 <- qplot(wine$alcohol, 
            geom = 'density',
            color = wine$type)  +
  labs(list (title = "Density Plot of Alcohol Concentration in Wines", 
             x = "Alcohol Concentration (% of Volume)", 
             y = "Density")) +
...
qplot(wine$type, 
      wine$alcohol, 
      geom = 'boxplot')   +
  labs(list (title = "Boxplot of Alcohol Concentration in Wines", 
             x = "Wine Type", 
             y = "Alcohol Concentration (% of Volume)"))
...
p1 <- qplot(wine$residual.sugar, 
  ...
  geom_vline(aes(xintercept = mean(wine$residual.sugar)), 
             colour = "red", 
             size = 1,
             show.legend = T) +
  geom_vline(aes(xintercept = quantile(wine$residual.sugar, 
                                       probs = c(.25, .50, .75))), 
             colour = "black", 
             linetype = "dashed",
             show.legend = T) +
  labs(list (title = "Histogram of Sugar Concentration in Wines", 
...
p2 <- qplot(wine$residual.sugar, 
      ...
      scale_x_continuous(limits = c(0, 
                                    quantile(wine$residual.sugar, 0.999))) +
  labs(list (title = "Density Plot of Sugar Concentration in Wines", 
             x = "Sugar Concentration (g/L)", 
             y = "Density")) +
  scale_color_discrete(name="Wine Type") +
  theme(legend.position="bottom")
...
qplot(wine$type, 
      wine$residual.sugar, 
      geom = 'boxplot')   +
  labs(list (title = "Boxplot of Sugar Concentration in Wines", 
             x = "Wine Type", 
...
p1 <- qplot(wine$chlorides, 
  ...
  geom_vline(aes(xintercept = mean(wine$chlorides)), 
             colour = "red", 
             size = 1,
             show.legend = T) +
  geom_vline(aes(xintercept = quantile(wine$chlorides, 
                                       probs = c(.25, .50, .75))), 
             colour = "black", 
             linetype = "dashed",
             show.legend = T) +
  labs(list (title = "Histogram of Salt (Chlorides) Concentration in Wines", 
             x = "Sodium Chloride (g/L)", 
             y = "Ocurrences")) +
  scale_fill_discrete(name="Wine Type") +
  theme(legend.position="bottom")
...
p2 <- qplot(wine$chlorides, 
      ...
      scale_x_continuous(limits = c(0, 
                                    quantile(wine$chlorides, 0.99))) +
  labs(list (title = "Density Plot of Salt (Chlorides) Concentration",
             x = "Sodium Chloride (g/L)", 
             y = "Density")) +
  scale_color_discrete(name="Wine Type") +
  theme(legend.position="bottom")
...
qplot(wine$type, 
      wine$chlorides, 
      geom = 'boxplot') +
  labs(list (title = "Boxplot of Salt (Chlorides) Concentration in Wines", 
             x = "Wine Type", 
             y = "Sodium Chloride (g/L)"))
...
p1 <- qplot(wine$density, 
            fill = wine$type,
            binwidth =0.0005)  +
      scale_x_continuous(limits = c(quantile(wine$density, 0.001), 
                                    quantile(wine$density, 0.999))) +
  geom_vline(aes(xintercept = mean(wine$density)), 
             colour = "red", 
             size = 1,
             show.legend = T) +
  geom_vline(aes(xintercept = quantile(wine$density, 
                                       probs = c(.25, .50, .75))), 
             colour = "black", 
             linetype = "dashed",
             show.legend = T) +
  labs(list (title = "Histogram of Density in Wines", 
             x = "Density (g/ml)", 
             y = "Ocurrences")) +
  scale_fill_discrete(name="Wine Type") +
  theme(legend.position="bottom")
...
p2 <- qplot(wine$density, 
      ...
      scale_x_continuous(limits = c(quantile(wine$density, 0.001), 
                                    quantile(wine$density, 0.999))) +
  labs(list (title = "Density Plot of Density in Wines", 
             x = "Density (g/ml)", 
             y = "Density")) +
  scale_color_discrete(name="Wine Type") +
  theme(legend.position="bottom")
...
qplot(wine$type, 
      wine$density, 
      geom = 'boxplot') +
  labs(list (title = "Boxplot of Density in Wines", 
             x = "Wine Type", 
             y = "Density (g/mL)"))
...
```{r fig.height=6, Acidity_Plots}

p1 <- qplot(wine$fixed.acidity, 
            fill = wine$type,
            binwidth =0.5) +
  geom_vline(aes(xintercept = mean(wine$fixed.acidity)), 
             colour = "red", 
             size = 1,
             show.legend = T) +
  geom_vline(aes(xintercept = quantile(wine$fixed.acidity, 
                                       probs = c(.25, .50, .75))), 
             colour = "black", 
             linetype = "dashed",
             show.legend = T) +
  labs(list (title = "Histogram of Fixed Acidity in Wines", 
             x = "Tartaric Acid (g/L)", 
             y = "Ocurrences")) +
  scale_fill_discrete(name="Wine Type")
...
p2 <- qplot(wine$fixed.acidity, 
            geom = 'density',
            color = wine$type) +
  labs(list (title = "Density Plot of Fixed Acidity in Wines", 
             x = "Tartaric Acid (g/L)", 
             y = "Density")) +
  scale_color_discrete(name="Wine Type")
...
p3 <- qplot(wine$citric.acid, 
            fill = wine$type,
            binwidth =0.05) +
  geom_vline(aes(xintercept = mean(wine$citric.acid)), 
             colour = "red", 
             size = 1,
             show.legend = T) +
  geom_vline(aes(xintercept = quantile(wine$citric.acid, 
                                       probs = c(.25, .50, .75))), 
             colour = "black", 
             linetype = "dashed",
             show.legend = T) +
  labs(list (title = "Histogram of Citric Acid Concentration in Wines", 
             x = "Citric Acid (g/L)", 
             y = "Ocurrences")) +
  scale_fill_discrete(name="Wine Type")
...
p4 <-qplot(wine$citric.acid, 
            geom = 'density',
            color = wine$type) +
  labs(list (title = "Density Plot of Citric Acid Concentration in Wines", 
             x = "Citric Acid (g/L)", 
             y = "Density")) +
  scale_color_discrete(name="Wine Type")
...
p5 <-qplot(wine$volatile.acidity, 
            fill = wine$type,
            binwidth =0.05) +
  geom_vline(aes(xintercept = mean(wine$volatile.acidity)), 
             colour = "red", 
             size = 1,
             show.legend = T) +
  geom_vline(aes(xintercept = quantile(wine$volatile.acidity, 
                                       probs = c(.25, .50, .75))), 
             colour = "black", 
             linetype = "dashed",
             show.legend = T) +
  labs(list (title = "Histogram of Volatile Acidity in Wines", 
             x = "Acetic Acid (g/L)", 
             y = "Ocurrences")) +
  scale_fill_discrete(name="Wine Type")
...
p6 <- qplot(wine$volatile.acidity, 
            geom = 'density',
            color = wine$type) +
  labs(list (title = "Density Plot of Volatile Acidity in Wines", 
             x = "Acetic Acid (g/L)", 
             y = "Density")) +
  scale_color_discrete(name="Wine Type")
...
p7 <- qplot(wine$pH, 
            fill = wine$type,
            binwidth =0.05) +
  geom_vline(aes(xintercept = mean(wine$pH)), 
             colour = "red", 
             size = 1,
             show.legend = T) +
  geom_vline(aes(xintercept = quantile(wine$pH, 
                                       probs = c(.25, .50, .75))), 
             colour = "black", 
             linetype = "dashed",
             show.legend = T) +
  labs(list (title = "Histogram of pH in Wines", 
             x = "pH", 
             y = "Ocurrences")) +
  scale_fill_discrete(name="Wine Type")
...
p8 <- qplot(wine$pH, 
            geom = 'density',
            color = wine$type) +
  labs(list (title = "Density Plot of pH in Wines", 
             x = "pH", 
             y = "Density")) +
  scale_color_discrete(name="Wine Type")
...
p9 <- qplot(wine$type,
            wine$fixed.acidity, 
            geom = 'boxplot') +
  labs(list (title = "Boxplot of Fixed Acidity in Wines", 
             x = "Wine Type", 
             y = "Tartaric Acid (g/L)"))
...
p10 <- qplot(wine$type,
            ...
            geom = 'boxplot') +
  labs(list (title = "Boxplot of Volatile Acidity in Wines", 
             x = "Wine Type", 
             y = "Acetic Acid (g/L)"))
...
p11 <- qplot(wine$type,
            wine$citric.acid, 
            geom = 'boxplot') +
  labs(list (title = "Boxplot of Citric Acid in Wines", 
             x = "Wine Type", 
             y = "Citric Acid (g/L)"))
...
p12 <- qplot(wine$type,
            wine$pH, 
            geom = 'boxplot') +
  labs(list (title = "Boxplot of pH in Wines", 
             x = "Wine Type", 
             y = "pH"))
...
```{r fig.height= 8, Sulfur_Plots}

p1 <- qplot(wine$sulphates, 
            fill = wine$type,
            binwidth =0.05) +
  geom_vline(aes(xintercept = mean(wine$sulphates)), 
             colour = "red", 
             size = 1,
             show.legend = T) +
  geom_vline(aes(xintercept = quantile(wine$sulphates, 
                                       probs = c(.25, .50, .75))), 
             colour = "black", 
             linetype = "dashed",
             show.legend = T) +
  labs(list (title = "Histogram of Sulphates in Wines", 
             x = "Potassium Sulphate (g/L)", 
             y = "Ocurrences")) +
  scale_fill_discrete(name="Wine Type")
...
p2 <- qplot(wine$total.sulfur.dioxide, 
            fill = wine$type,
            binwidth =10) +
  geom_vline(aes(xintercept = mean(wine$total.sulfur.dioxide)), 
             colour = "red", 
             size = 1,
             show.legend = T) +
  geom_vline(aes(xintercept = quantile(wine$total.sulfur.dioxide, 
                                       probs = c(.25, .50, .75))), 
             colour = "black", 
             linetype = "dashed",
             show.legend = T) +
  ...
  labs(list (title = "Histogram of Total Sulfur Dioxide in Wines", 
             x = "Total Sulfur Dioxide (ppm)", 
             y = "Ocurrences")) +
  scale_fill_discrete(name="Wine Type")
...
p3 <- qplot(wine$free.sulfur.dioxide, 
            fill = wine$type,
            binwidth =5) +
  geom_vline(aes(xintercept = mean(wine$free.sulfur.dioxide)), 
             colour = "red", 
             size = 1,
             show.legend = T) +
  geom_vline(aes(xintercept = quantile(wine$free.sulfur.dioxide, 
                                       probs = c(.25, .50, .75))), 
             colour = "black", 
             linetype = "dashed",
             show.legend = T) +
  ...
  labs(list (title = "Histogram of Free Sulfur Dioxide in Wines", 
...
p4 <- qplot(wine$sulphates, 
            geom = 'density',
            color = wine$type) +
  labs(list (title = "Density Plot of Sulphates in Wines", 
             x = "Potassium Sulphate (g/L)", 
             y = "Density")) +
  scale_color_discrete(name="Wine Type")
...
p5 <- qplot(wine$total.sulfur.dioxide, 
      ...
      scale_x_continuous(
        limits = c(0, quantile(wine$total.sulfur.dioxide, 0.99))) +
  labs(list (title = "Density Plot of Total Sulfur Dioxide in Wines", 
             x = "Total Sulfur Dioxide (ppm)", 
             y = "Density")) +
  scale_color_discrete(name="Wine Type")
...
p6 <- qplot(wine$free.sulfur.dioxide, 
      ...
      scale_x_continuous(
        limits = c(0, quantile(wine$free.sulfur.dioxide, 0.99))) +
  labs(list (title = "Density Plot of Free Sulfur Dioxide in Wines", 
             x = "Free Sulfur Dioxide (ppm)", 
             y = "Density")) +
  scale_color_discrete(name="Wine Type")
...
p7 <- qplot(wine$type,
            wine$sulphates, 
            geom = 'boxplot') +
  labs(list (title = "Sulphates", 
             x = "Wine Type", 
             y = "Potassium Sulphate (g/L)"))

p8 <- qplot(wine$type,
            wine$total.sulfur.dioxide, 
            geom = 'boxplot') +
  labs(list (title = " Total Sulfur Dioxide", 
             x = "Wine Type", 
             y = "Total Sulfur Dioxide (g/L)"))

p9 <- qplot(wine$type,
            wine$free.sulfur.dioxide, 
            geom = 'boxplot') +
  labs(list (title = "Free Sulfur Dioxide", 
             x = "Wine Type", 
             y = "Free Sulfur Dioxide (g/L)"))
...
```{r GG_Pairs, fig.width=12, fig.height=8}

ggpairs(wine, 
  lower =  list(continuous = wrap("smooth", alpha = 0.7)), 
  upper = list(combo = "box", continuous = wrap("cor", size = 3)),
...
```{r fig.height= 3, Quality_Bivariate_Analysis_Alcohol}
...
```{r fig.height= 3, Quality_Bivariate_Analysis_Volatile_Acidity}
...
```{r fig.height= 3, Quality_Bivariate_Analysis_Citric_Acid}
...
ggplot(aes(x = quality, 
  ...
  stat_summary(fun.y=median, 
               ...
               color = 'red') +
  facet_wrap( ~ type) +
  labs(list (title = "Quality vs. Citric Acid Concentration", 
             x = "Quality Rating", 
             y = "Citric Acid (g/L)"))
...
```{r fig.height= 3, Quality_Bivariate_Chlorides}
...
ggplot(aes(x = quality, 
  ...
  stat_summary(fun.y=median, 
               ...
               color = 'red') +
  scale_y_continuous(
    limits = c(0, quantile(wine$chlorides, 0.95))) +
  facet_wrap( ~ type) +
  labs(list (title = "Quality vs. Salt (Chlorides) Concentration", 
             x = "Quality Rating", 
             y = "Sodium Chloride (g/L)"))
...
```{r fig.height= 8, Quality_Bivariate_Denstiy_pH_Sulphates}

p5 <- ggplot(aes(x = quality, 
                 y = density),
            data = wine) + 
  geom_boxplot() +
  stat_summary(fun.y=median, 
               ...
               color = 'red') +
  scale_y_continuous(
    limits = c(quantile(wine$density, 0.01), 
               quantile(wine$density, 0.99))) +
  facet_wrap( ~ type) +
  labs(list (title = "Quality vs. Density", 
             x = "Quality Rating", 
             y = "Density (g/mL)"))
...
p6 <- ggplot(aes(x = quality, 
  ...
  stat_summary(fun.y=median, 
               ...
               color = 'red') +
  facet_wrap( ~ type) +
  labs(list (title = "Quality vs. pH", 
             x = "Quality Rating", 
             y = "pH"))

p7 <- ggplot(aes(x = quality, 
                 y = sulphates),
       data = wine) + 
  geom_boxplot() +
  stat_summary(fun.y=median, 
...
```{r White_Wine_Correlation_Matrix}
...
ggplot(aes(x = fixed.acidity, 
  ...
  stat_smooth(method = 'lm', 
              aes(color=type)) +
  labs(list (title = "pH vs. Fixed Acidity", 
             x = "Acetic Acid (g/L)", 
             y = "pH")) +
  scale_color_discrete(name="Wine Type")
...
ggplot(aes(x = volatile.acidity, 
  ...
  stat_smooth(method = 'lm', 
              aes(color=type)) +
  labs(list (title = "pH vs. Volatile Acidity", 
             x = "Tartaric Acid (g/L)", 
             y = "pH")) +
  scale_color_discrete(name="Wine Type")
...
ggplot(aes(x = citric.acid, 
  ...
  stat_smooth(method = 'lm',
              aes(color=type)) +
  labs(list (title = "pH vs. Citric Acid", 
             x = "Citric Acid (g/L)", 
             y = "pH")) +
  scale_color_discrete(name="Wine Type")
...
ggplot(aes(x = residual.sugar, 
  ...
  labs(list (title = "Total Sulfur Dioxide vs. Residual Sugar", 
...
ggplot(aes(x = residual.sugar, 
  ...
  coord_cartesian(xlim = c(quantile(wine$residual.sugar, 0.01), 
                           quantile(wine$residual.sugar, 0.99)), 
                  ylim = c(quantile(wine$free.sulfur.dioxide, 0.01),
                           quantile(wine$free.sulfur.dioxide, 0.99))) + 
  labs(list (title = "Free Sulfur Dioxide vs. Residual Sugar", 
             x = "Residual Sugar (g/L)", 
             y = "Free Sulfur Dioxide (ppm)")) +
  scale_color_discrete(name="Wine Type")
...
ggplot(aes(x = residual.sugar, 
  ...
  coord_cartesian(xlim = c(quantile(wine$residual.sugar, 0.01), 
                  ...
                  ylim = c(quantile(wine$density, 0.01), 
                           quantile(wine$density, 0.99))) +
  labs(list (title = "Density vs. Residual Sugar", 
             x = "Residual Sugar (g/L)", 
             y = "Density (g/mL))")) +
  scale_color_discrete(name="Wine Type")
...
ggplot(aes(x = alcohol, 
  ...
  stat_smooth(method = 'lm', 
              aes(color=type)) +
  coord_cartesian(ylim = c(quantile(wine$residual.sugar, 0.01), 
                           quantile(wine$residual.sugar, 0.99))) +
  labs(list (title = "Alcohol vs. Residual Sugar", 
             x = "Alcohol (% of Volume)", 
...
ggplot(aes(x = alcohol,
  ...
  stat_smooth(method = 'lm', 
              aes(color=type)) +
  coord_cartesian(ylim = c(quantile(wine$chlorides, 0.01), 
                           quantile(wine$chlorides, 0.99))) +
  labs(list (title = "Alcohol vs. Chlorides", 
             x = "Alcohol (% of Volume)", 
             y = "Sodium Chloride (g/L)")) +
  scale_color_discrete(name="Wine Type")
...
ggplot(aes(x = alcohol, 
  ...
  stat_smooth(method = 'lm', 
              aes(color=type)) +
  coord_cartesian(ylim = c(quantile(wine$total.sulfur.dioxide, 0.01),  
                           quantile(wine$total.sulfur.dioxide, 0.99))) +
  labs(list (title = "Alcohol vs. Total Sulfur Dioxide", 
             x = "Alcohol (% of Volume)", 
             y = "Total Sulfur Dioxide (ppm)")) +
  scale_color_discrete(name="Wine Type")
...
ggplot(aes(x = alcohol, 
  ...
  stat_smooth(method = 'lm', 
              aes(color=type)) +
  coord_cartesian(ylim = c(quantile(wine$density, 0.01), 
                           quantile(wine$density, 0.99))) +
  labs(list (title = "Alcohol vs. Density", 
             x = "Alcohol (% of Volume)", 
             y = "Density (g/mL)")) +
  scale_color_discrete(name="Wine Type")
...
```{r Multivariate_Analysis_Alcohol_Density}
...
ggplot(aes(x = alcohol, 
  ...
  stat_ellipse(size = 1, 
               ...
               linetype = 1) +
  facet_wrap( ~ type) +
  labs(list (title = "Alcohol vs. Density by Quality Rating", 
             x = "Alcohol (% of Volume)", 
             y = "Density (g/mL)"))
...
```{r Multivariate_Analysis_Alcohol_Volatile}
...
ggplot(aes(x = alcohol, 
  ...
  stat_ellipse(size = 1, 
               ...
               linetype = 1) +
  facet_wrap( ~ type) +
  labs(list (title = "Alcohol vs. Volatile Acidity by Quality Rating", 
             x = "Alcohol (% of Volume)", 
             y = "Acetic Acid (g/L)"))
...
```{r Multivariate_Analysis_Alcohol_Chlorides}
...
ggplot(aes(x = chlorides, 
  ...
  stat_ellipse(size = 1, 
               ...
               linetype = 1) +
  facet_wrap( ~ type) +
  labs(list (title = "Citric Acid vs. Chlorides by Quality Rating", 
             x = "Sodium Chloride (g/L)", 
             y = "Citric Acid (g/L)"))
...
```{r Multivariate_Analysis_Sulphates_Total_Sulfur}
...
ggplot(aes(x = sulphates, 
  ...
  stat_ellipse(size = 1, 
               ...
               linetype = 1) +
  facet_wrap( ~ type) +
  labs(list (title = "Sulphates vs. Total Sulfur Dioxide by Quality Rating", 
             x = "Sulphates (g/L)", 
             y = "Total Sulfur Dioxide (ppm)"))
...
```{r Red_Linear_Model_Validation}

#Adding predicted quality score to the dataset
red$predict.quality   <- round((3.095 + 
                                0.314*red$alcohol - 
                                1.384*red$volatile.acidity), 
                               digits=0)
#Calculating predicted quality score deviation from actual score
red$predict.deviation <- red$quality - red$predict.quality
#Creating boolean variable to indicate if prediction was correct
red$predict.correct   <- red$predict.deviation == 0
#Checking number of correct predictions and accuracy rate
...
```{r White_Linear_Model_Validation}

#Adding predicted quality score to the dataset
white$predict.quality   <- round((2.582 + 
                                    0.313*white$alcohol), 
                                 digits=0)
#Calculating predicted quality score deviation from actual score
